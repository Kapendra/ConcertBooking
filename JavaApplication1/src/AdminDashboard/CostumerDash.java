...
public class CostumerDash extends javax.swing.JFrame {
    ...
    private void fetch(){
        ...
        try{
            String query = "SELECT concertId, concertName, location, date FROM concert WHERE concertStatus = \"active\";";
            st = con.prepareStatement(query);
            rs = st.executeQuery();
...
//
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CostumerDash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CostumerDash().setVisible(true);
            }
        });
    }
